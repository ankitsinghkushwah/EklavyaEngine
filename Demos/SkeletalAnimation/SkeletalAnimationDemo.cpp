...
//}
//
//MaterialInfo SkeletalAnimationDemo::LoadMaterialInfo(const std::string &file,
//                                                     std::string ext) {
//  MaterialInfo info;
//
...
//  info.mCubemap =
//      mRenderer
//          ->GetMaterialForGroup<SkyboxMaterial>(Renderer::ERenderGroup::SKYBOX)
//          ->mCubemap;
//
//  return info;
//}
...
//}
//
//void SkeletalAnimationDemo::ImGuiProc() { MainEntryScene::ImGuiProc(); }
//
//#ifdef EKDEBUG
