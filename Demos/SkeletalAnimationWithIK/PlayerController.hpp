...
private:
	...
	std::array<std::array<SHARED_ANIMATION, EMovementDirection::MD_MAX>, EPlayerStance::PS_MAX> mStandingMovementAnims;
	// idle, walk, turn left, turn right
