...
class AssetFactory {
public:
  static SHARED_TEXTURE CreateTexture(std::string assetName, std::string ext,
                                      bool repeat = false);
  ...
  static SHARED_MODEL CreateModel(std::string assetName, std::string ext,
                                  int modelID); /*model id is used to read/write
to AnimationData which is shared by animation and model */
  static SHARED_ANIMATION CreateAnimation(std::string assetName,
