...
public:
  ...
  void Create(Type *bufferData, long bufferDataSize, int *Indices,
  ...
  bool HasSharedVertices() { return mIndicesSize != -1; }
  int GetIndicesSize() { return mIndicesSize; }
  void Unbind() { glBindVertexArray(0); }
  static void SetupVAOForSphere(VertexArrayObject &vao, glm::vec3 &min,
                                glm::vec3 &max);
  static void SetupVAOForBox(VertexArrayObject &vao, glm::vec3 &min,
                             glm::vec3 &max);
...
void VertexArrayObject::Create(Type *bufferData, long bufferDataSize,
