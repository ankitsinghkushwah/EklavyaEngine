...
DebugRenderer::DebugRenderer()
{
  glm::vec3 min, max;
  mUnlitSolids =
      AssetManager::GetInstance().GetAsset<ShaderProgram>("unlit_solids");
...
void DebugRenderer::DrawSphere(glm::vec3 center, glm::vec3 extents,
                               glm::vec4 color)
{
  glm::vec3 rotation;
...
void DebugRenderer::DrawBox(glm::vec3 center, glm::vec3 rotation,
                            glm::vec3 extents, glm::vec4 color)
{
  glm::mat4 model = GetModel(center, glm::quat(rotation), extents);
...
void DebugRenderer::DrawBound(const glm::mat4 &model, const Bound &bound,
                              glm::vec4 color)
{
...
void DebugRenderer::AddLine(glm::vec3 start, glm::vec3 end, glm::vec4 color,
                            float thickness)
{
