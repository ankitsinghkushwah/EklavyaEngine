...
namespace Eklavya::Renderer
{
	class IFramebuffer
	{
	  public:
		...
		virtual unsigned int ColorOutput() const
		{
			return 0;
		}

		virtual unsigned int DepthOutput() const
		{
			return 0;
		}
	...
	class ShadowPassFB : public IFramebuffer
	{
	  public:
		...
		unsigned int DepthOutput() const override
		{
			return mDepthOutput;
		}
	...
	class GeneralFB : public IFramebuffer
	{
	  public:
		...
		unsigned int ColorOutput() const override
		{
			return mColorOutput;
		}
